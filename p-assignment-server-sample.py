...
# This program runs 
# connects to the COE Genesys machine and performs mathematical operations requested by the server.
# Once this is complete, a secret flag is acquired and the connection is closed.
# Author:
#   Carlos Bocanegra, PhD Candidate,
#   EECE department, Northeastern university, Ell 301 lab
...
defaultPort = 12000
secretKey="This sample key is secret"
